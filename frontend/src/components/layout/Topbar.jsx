...
const Topbar = () => {
    const { user } = useAuth();
    const wallet = user?.wallet || { coins: 0, energy: 0, streak: 0 };
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-surface rounded-full border border-slate-700/50">
                        ...
                        <span className="text-sm font-bold text-white">{wallet.streak}</span>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-surface rounded-full border border-slate-700/50">
                    ...
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-surface rounded-full border border-slate-700/50">
                        ...
                        <span className="text-sm font-bold text-white">{wallet.energy}</span>
                    </div>
                </div>
